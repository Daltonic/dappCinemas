  ...
  return (
    <div className='flex flex-col w-full p-4 space-y-4'>
            ...
            <div className='flex text-center align-center m-auto space-x-8'>
                <p className='font-bold'>DATE: <span className='font-thin'>February 9, Thursday</span></p>
            ...
            <sub>5/10 <span>spaces</span></sub>
            <button className="bg-black py-1 px-4 text-xs font-bold text-white border-2 border-black
